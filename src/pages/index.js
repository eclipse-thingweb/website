      ...
      <main>
              ...
              <div className={clsx(styles.feature, styles.seamlessIntegration)}>
                <div className={styles.feature__icon}>
                  <svg width="100%" height="auto" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" className={styles.puzzleIcon}>
                    ...
                    219.617 105.898 224 100.496 224H87.7337C85.4099 224 83.5208 222.111 83.5208 219.787C83.5208 218.153 84.5635 216.596 86.0833 215.467Z" stroke="black" strokeWidth="2" />
              ...
              <div className={clsx(styles.feature, styles.communityDriven)}>
                <div className={styles.feature__icon}>
                  <svg width="100%" height="auto" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" className={styles.communityIcon}>
                    <path className={styles.bodyLeft} d="M26 134.093C26 115.972 40.7187 101.27 58.8669 101.27H88.6941C106.842 101.27 121.561 115.972 121.561 134.093C121.561 137.271 118.984 139.867 115.777 139.867H31.7835C28.5974 139.867 26 137.292 26 134.093Z" stroke="black" strokeWidth="2" />
                    ...
                    <path className={styles.bodyRight} d="M128.439 134.068C128.439 115.947 143.158 101.246 161.306 101.246H191.133C209.281 101.246 224 115.947 224 134.068C224 137.247 221.423 139.843 218.216 139.843H134.223C131.036 139.843 128.439 137.268 128.439 134.068Z" stroke="black" strokeWidth="2" />
                    <path className={styles.headRight} d="M153 67.3934C153 61.1988 155.464 55.2577 159.85 50.8771C164.237 46.4964 170.186 44.0352 176.39 44.0352C182.594 44.0352 188.544 46.4964 192.93 50.8771C197.317 55.2577 199.78 61.1988 199.78 67.3934C199.78 73.588 197.317 79.5291 192.93 83.9097C188.544 88.2904 182.594 90.7516 176.39 90.7516C170.186 90.7516 164.237 88.2904 159.85 83.9097C155.464 79.5291 153 73.588 153 67.3934Z" stroke="black" strokeWidth="2" />
                    <path className={styles.bodyCenter} d="M65.292 198.285C65.292 174.911 84.2766 155.95 107.684 155.95H145.9C169.307 155.95 188.292 174.911 188.292 198.285C188.292 202.512 184.865 205.965 180.601 205.965H72.9834C68.7468 205.965 65.292 202.54 65.292 198.285Z" stroke="black" strokeWidth="2" />
                    <path className={styles.headCenter} d="M96.583 113.338C96.583 105.326 99.7697 97.6426 105.443 91.9773C111.115 86.3118 118.81 83.1288 126.833 83.1288C134.856 83.1288 142.551 86.3118 148.223 91.9773C153.896 97.6426 157.083 105.326 157.083 113.338C157.083 121.349 153.896 129.033 148.223 134.698C142.551 140.364 134.856 143.547 126.833 143.547C118.81 143.547 111.115 140.364 105.443 134.698C99.7697 129.033 96.583 121.349 96.583 113.338Z" stroke="black" strokeWidth="2" />
                  </svg>
                </div>
        ...
        <section className={styles.communitySection}>
          <div className={clsx('container', styles.communitySection__container)}>
            ...
            <div className={styles.communitySection__scroller} data-direction="left" data-speed="slow">
