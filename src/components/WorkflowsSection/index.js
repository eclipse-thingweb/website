        ...
        <section className={styles.workflowsSection}>
            <div className={clsx("container", "section-wrapper")}>
                <div className={styles.workflowsSection__buttons}>
                    ...
                    />
                    <div
                        className={clsx(styles.progressBar, styles.barLeft)}
                        data-show="false"
                        id="progress-bar-left"
                    ></div>
                    <input type="radio" id="hw-btn" className={styles.workflowBtn} name="workflow-btn" value="hw" />
                    <div
                        className={clsx(styles.progressBar, styles.barRight)}
                        data-show="false"
                        id="progress-bar-right"
                    ></div>
                ...
                <div className={styles.workflowsSection__workflows}>
                    <div className={styles.workflowsWrapper}>
                            ...
                            <div className={styles.workflow__content}>
                                ...
                                <ul className={styles.benefits}>
                                    <li className={styles.benefit}>
                                        ...
                                        <span className={styles.highlight}>Standardized Interface:</span> Interact with
                                        different device types and brands through a single, fixed interface.
                                    </li>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>Low Integration Barrier:</span> Quickly
                                        enables cross-manufacturer device connectivity without redesigning device
                                        protocols.
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div
                            className={clsx(styles.workflow, styles.homogeneousW)}
                            id="workflow"
                        ...
                        >
                            ...
                            <div className={styles.workflow__content}>
                                ...
                                <ul className={styles.benefits}>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>Structured Interactions:</span> WoT
                                        transforms devices into documented APIs, making it easier for newcomers.
                                    </li>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>Enhanced Accessibility:</span> Simplifies
                                        device control for broader audiences, allowing third parties to interface with
                                        devices seamlessly.
                                    </li>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>Built in security:</span> Use web tested
                                        access control policies and security protocols out of the box.
                                    </li>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>Out of the box:</span> Decisions are taken
                                        for you, (protocol, best practices, documentation, security)
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div
                            className={clsx(styles.workflow, styles.professionalW)}
                            id="workflow"
                            data-workflow="simple"
                        >
                            <div className={styles.workflow__illustration}>
                            ...
                            <div className={styles.workflow__content}>
                                ...
                                <p className={styles.description}>
                                    Easily manage a fleet of heterogeneous devices and orchestrate applications at
                                    scale.
                                </p>
                                <ul className={styles.benefits}>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>Scalability:</span> Supports complex setups
                                        with distributed devices and extensive device fleets.
                                    </li>
                                    <li className={styles.benefit}>
                                        <FontAwesomeIcon icon={faThumbsUp} className={styles.icon} />
                                        <span className={styles.highlight}>
                                            Ready to use microservices and fleet management:
                                        </span>{" "}
                                        Efficiently handle a wide range of devices using Thingweb’s microservices for
