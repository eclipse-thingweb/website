    ...
    return (
        <section className={styles.toolsSection} id="tools-section">
            <div className={clsx("container", "section-wrapper")}>
                <h2 className={clsx("hero-title", "section-title", styles.toolsSection__title)}>
                    Powerful <span className={"text-highlight"}>Tools</span> To Drive Your IoT Development
                </h2>

                <p className={clsx("section-subheader", styles.toolsSection__subheader)}>
                    Thingweb has the components you need to interact with your devices, tools to design Thing
                    Descriptions and services to manage your devices. Pick what you need, use as you see fit.{" "}
                </p>
