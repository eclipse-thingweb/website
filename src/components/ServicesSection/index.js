...
const thingsList1 = [
    {
        ...
        title: "Counter",
        description:
            "It has a count property that can be read or observed and can be incremented or decremented via separate actions.",
        tags: ["HTTP", "CoAP"],
    },
    {
        type: "thing",
    ...
    },
    {
        ...
        description:
            "This is a simulation of a coffee machine that also has a simple user interface that displays the values of properties.",
        tags: ["HTTP", "CoAP"],
    },
    {
        type: "protocol",
    ...
    },
    {
        ...
        title: "Smart  Clock",
        description:
            "It has a property affordance for the time. However, it runs 60 times faster than real-time to allow time-based decisions.",
        tags: ["CoAP"],
    },
    {
        type: "thing",
    ...
    return (
        <section className={styles.servicesSection}>
            <div className={clsx("container", "section-wrapper")}>
                <h2 className={clsx("hero-title", "section-title", styles.servicesSection__title)}>
                    Test your <span className={"text-highlight"}>WoT</span> Applications
                </h2>

                <p className={clsx("section-subheader", styles.servicesSection__subheader)}>
                    Thingweb also provides you with a variety of publicly available Things for you to interact with over
                    the internet.
                </p>
