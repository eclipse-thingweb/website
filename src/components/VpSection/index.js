    ...
    return (
        <section className={styles.vpSection} id="vp-section">
            <div className={clsx("container", "section-wrapper")}>
                <h2 className={clsx("hero-title", "section-title", styles.vpSection__title)}>
                    Unlock the True <span className={"text-highlight"}>Potential of IoT</span>
                </h2>

                <p className={clsx("section-subheader", styles.vpSection__subheader)}>
                ...
                <div className={styles.vpSection__features}>
                    <div className={clsx(styles.feature, styles.powerfulFeatures)}>
                        <div className={styles.feature__icon}>
                            ...
                            >
                                ...
                                <path
                                    ...
                                    d="M63.8633 224.798L104.079 184.582"
                                    stroke="black"
                                    strokeWidth="1"
                                    strokeLinecap="round"
                                />
                        ...
                        <p className={styles.feature__description}>
                            Build IoT applications with secure, scalable web capabilities, flexible protocols, device
                            fleet management, and documentation.
                        </p>
                    </div>
                    ...
                    96.8214 115.521 96.8214C113.933 96.8214 112.567 97.2129 111.609 98.1887C110.655 99.1608 110.281 100.535 110.281 102.114V129.257C110.281 134.659 105.898 139.042 100.496 139.042H87.7337C85.41 139.042 83.5209 137.153 83.5209 134.829C83.5209 133.195 84.5635 131.638 86.0834 130.509Z"
                        ...
                        <p className={styles.feature__description}>
                            Eliminate compatibility headaches by leveraging Web standards to ensure your applications
                            remain compatible and adaptable.
                        </p>
                    </div>
                    ...
                    <div className={clsx(styles.feature, styles.communityDriven)}>
                        <div className={styles.feature__icon}>
                            ...
                            >
                                <path
                                    ...
                                    d="M26 134.093C26 115.972 40.7187 101.27 58.8669 101.27H88.6941C106.842 101.27 121.561 115.972 121.561 134.093C121.561 137.271 118.984 139.867 115.777 139.867H31.7835C28.5974 139.867 26 137.292 26 134.093Z"
                                    stroke="black"
                                    strokeWidth="1"
                                />
                                <path
                                    className={styles.headLeft}
                                    d="M51 67.4637C51 61.2691 53.464 55.328 57.8504 50.9474C62.2368 46.5667 68.1863 44.1055 74.3902 44.1055C80.5942 44.1055 86.5437 46.5667 90.9301 50.9474C95.3165 55.328 97.7805 61.2691 97.7805 67.4637C97.7805 73.6583 95.3165 79.5994 90.9301 83.98C86.5437 88.3607 80.5942 90.8219 74.3902 90.8219C68.1863 90.8219 62.2368 88.3607 57.8504 83.98C53.464 79.5994 51 73.6583 51 67.4637Z"
                                    stroke="black"
                                    strokeWidth="1"
                                />
                                <path
                                    className={styles.bodyRight}
                                    d="M128.439 134.068C128.439 115.947 143.158 101.246 161.306 101.246H191.133C209.281 101.246 224 115.947 224 134.068C224 137.247 221.423 139.843 218.216 139.843H134.223C131.036 139.843 128.439 137.268 128.439 134.068Z"
                                    stroke="black"
                                    strokeWidth="1"
                                />
                                <path
                                    className={styles.headRight}
                                    d="M153 67.3934C153 61.1988 155.464 55.2577 159.85 50.8771C164.237 46.4964 170.186 44.0352 176.39 44.0352C182.594 44.0352 188.544 46.4964 192.93 50.8771C197.317 55.2577 199.78 61.1988 199.78 67.3934C199.78 73.588 197.317 79.5291 192.93 83.9097C188.544 88.2904 182.594 90.7516 176.39 90.7516C170.186 90.7516 164.237 88.2904 159.85 83.9097C155.464 79.5291 153 73.588 153 67.3934Z"
                                    stroke="black"
                                    strokeWidth="1"
                                />
                                <path
                                    className={styles.bodyCenter}
                                    d="M65.292 198.285C65.292 174.911 84.2766 155.95 107.684 155.95H145.9C169.307 155.95 188.292 174.911 188.292 198.285C188.292 202.512 184.865 205.965 180.601 205.965H72.9834C68.7468 205.965 65.292 202.54 65.292 198.285Z"
                                    stroke="black"
                                    strokeWidth="1"
                                />
                                <path
                                    className={styles.headCenter}
                                    d="M96.583 113.338C96.583 105.326 99.7697 97.6426 105.443 91.9773C111.115 86.3118 118.81 83.1288 126.833 83.1288C134.856 83.1288 142.551 86.3118 148.223 91.9773C153.896 97.6426 157.083 105.326 157.083 113.338C157.083 121.349 153.896 129.033 148.223 134.698C142.551 140.364 134.856 143.547 126.833 143.547C118.81 143.547 111.115 140.364 105.443 134.698C99.7697 129.033 96.583 121.349 96.583 113.338Z"
                                    stroke="black"
                                    strokeWidth="1"
                                />
                            </svg>
                        ...
                        <p className={styles.feature__description}>
                            Join our open community! Everyone has the power to contribute and make a meaningful impact
                            on the future of Thingweb.
                        </p>
                    </div>
                </div>
            </div>
