...
import { faFile, faHouse, faScrewdriverWrench, faLaptopCode, faDisplay, faMobile, faCubes, faQuestion } from '@fortawesome/free-solid-svg-icons'

export default function ClientOnlyWorkflow() {
    return (
        <div className={styles.clientOnlyWorkflow}>
            <svg width="auto" height="auto" viewBox="0 0 137 56" fill="none" xmlns="http://www.w3.org/2000/svg" className={clsx(styles.clientOnlyWorkflow__line, styles.line1)}>
            ...
            <svg width="auto" height="auto" viewBox="0 0 43 205" fill="none" xmlns="http://www.w3.org/2000/svg" className={clsx(styles.clientOnlyWorkflow__line, styles.line2)}>
            ...
            <svg width="auto" height="auto" viewBox="0 0 46 124" fill="none" xmlns="http://www.w3.org/2000/svg" className={clsx(styles.clientOnlyWorkflow__line, styles.line3)}>
            ...
            <svg width="auto" height="auto" viewBox="0 0 45 43" fill="none" xmlns="http://www.w3.org/2000/svg" className={clsx(styles.clientOnlyWorkflow__line, styles.line4)}>
            ...
            <svg width="auto" height="auto" viewBox="0 0 120 121" fill="none" xmlns="http://www.w3.org/2000/svg" className={clsx(styles.clientOnlyWorkflow__line, styles.line5)}>
            ...
            <svg width="auto" height="auto" viewBox="0 0 46 122" fill="none" xmlns="http://www.w3.org/2000/svg" className={clsx(styles.clientOnlyWorkflow__line, styles.line6)}>
